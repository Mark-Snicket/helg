...
public class ModArmorMaterials {
    ...
    public static final ResourceKey<EquipmentAsset> HELG_KEY = ResourceKey.create(REGISTRY_KEY, Identifier.fromNamespaceAndPath(Helg.MOD_ID, "helg"));
    ...
    }), 15, SoundEvents.ARMOR_EQUIP_ELYTRA, 1, 0, ModTags.Items.HELGERITE_ARMOR_REPAIRABLES, HELGERITE_KEY);

    public static final ArmorMaterial HELG_ARMOR_MATERIAL = new ArmorMaterial(25, Util.make(new EnumMap<>(ArmorType.class), map -> {
        map.put(ArmorType.BODY,13);
    }), 15, SoundEvents.ARMOR_EQUIP_ELYTRA, 1, 0, ModTags.Items.HELGERITE_ARMOR_REPAIRABLES, HELG_KEY);
}
